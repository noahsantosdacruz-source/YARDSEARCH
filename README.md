[README(1).md](https://github.com/user-attachments/files/30265697/README.1.md)
...
| `ChantierConnect/` | Plateforme de mise en relation clients ↔ artisans du bâtiment (React + Vite) — recherche de pros, devis, messagerie, suivi de chantiers |
